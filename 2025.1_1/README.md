...
- [Siemens Catapult 2025.1_1](https://support.sw.siemens.com/en-US/product/886857312/download/202503079)
...
echo $MGC_HOME
```
It should point to your local installation of Catapult, for example, `/tools/Siemens/catapult/2025.1_1/Mgc_home`. 

If empty, you can define it, for example:
```
export MGC_HOME=/tools/Siemens/catapult/2025.1_1/Mgc_home # make it sure to use your installation path
```
...
which python3
```
That should return something like `/tools/Siemens/catapult/2025.1_1/Mgc_home/bin/python3`; if instead, it is `/usr/bin/python3`, then either `PATH` or `MGC_HOME` are not properly set.
...
Make sure the following tools and libraries are installed besides Catapult 2025.1_1:
- Siemens QuestaSim 2023.2
- Synopsys Novas/Verdi T-2022.06-SP2-1
- Synopsys SAED32nm_PDK_02_2024
...
First:
```
PYTHONPATH=$MGC_HOME/shared/pkgs/ccs_hls4ml/hls4ml python examples/Simple/model_asic.py --reuse_factor=1
```
