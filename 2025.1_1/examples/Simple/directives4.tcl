...
flow run /HLS4ML/gen_hls4ml $sfd/model.py --reuse_factor 4

# Now 'dofile' the project
if { [file exists [pwd]/my-Catapult-test4] } {
  set_working_dir [pwd]/my-Catapult-test4
  dofile build_prj.tcl
} else {
  logfile message "HLS4ML failed to generate the model in directory '[pwd]/my-Catapult-test4'\n" error
}
