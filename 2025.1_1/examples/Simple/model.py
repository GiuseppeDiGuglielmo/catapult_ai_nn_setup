...
if __name__ == '__main__':
    ...
    model_name = 'simple'
    proj_name = 'myproject'
    out_dir = 'my-Catapult-test' + str(args.reuse_factor)
    ...
    config_ccs = catapult_ai_nn.config_for_dataflow(model=model, x_test=x_test, y_test=y_test, num_samples=10, 
    ...
    # if 0:
        ...
        # np.savetxt('ccs_hls_model_predictions.dat', ccs_hls_model_predictions, fmt='%d')
